    ...
    <div class="flex flex-auto justify-center">
        <ul class="flex flex-row mx-auto my-auto font-normal opacity-[.80] bg-slate-100 p-4 pt-6 rounded-b fixed z-40 items-center pt">
           ...
           document.getElementById('logout-form').submit();">
            ...
            <li>
                <a href="{{route('about')}}"
                   class="{{request()->is('about') ? 'bg-black text-white ':''}} p-2 rounded mx-8
                   duration-300"
...
<div class="flex justify-center rounded-xl my-4">
    <div class="text-black bg-slate-100 shadow-2xl w-4/5 rounded-xl ">
        <a href="{{route('home')}}">
            <img
                ...
                width="50" height="50" class="rounded-full m-3 fixed">
        </a>
        @yield('content')
        <div class="z-50">
        </div>
